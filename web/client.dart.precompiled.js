...
function dart_precompiled($collectedClasses) {
  ...
  function DisplayObject(visible, hitArea, __iParent, interactiveChildren, __hit, __isOver, __mouseIsDown, __isDown, click, mousemove, mousedown, mouseout, mouseover, mouseup, mouseupoutside, touchmove, touchstart, touchend, tap, __touchData, stage, buttonMode, _interactive, defaultCursor, worldTransform) {
  ...
  DisplayObject.prototype.set$__iParent = function(v) {
    return this.__iParent = v;
  };
  DisplayObject.prototype.get$interactiveChildren = function() {
  ...
  DisplayObject.prototype.get$stage = function() {
    return this.stage;
  };
  ...
  DisplayObject.prototype.set$worldTransform = function(v) {
    return this.worldTransform = v;
  };
  ...
  Stage.prototype.set$worldTransform = function(v) {
    return this.PIXI$Stage$worldTransform = v;
  };
  ...
  InteractionManager.prototype.get$stage = function() {
    return this.stage;
  };
  InteractionManager.prototype.set$target = function(receiver, v) {
    return this.target = v;
  };
  InteractionManager.prototype.get$last = function(receiver) {
    return this.last;
  };
  ...
  function main_animate(box_0, ren_3) {
    this.box_0 = box_0;
    this.ren_3 = ren_3;
  }
  ...
  function main_enterState(box_0, socket_4, kb_5) {
    this.box_0 = box_0;
    this.socket_4 = socket_4;
    this.kb_5 = kb_5;
  }
  main_enterState.builtin$cls = "main_enterState";
  if (!"name" in main_enterState)
    main_enterState.name = "main_enterState";
  $desc = $collectedClasses.main_enterState;
  if ($desc instanceof Array)
    $desc = $desc[1];
  main_enterState.prototype = $desc;
  function State() {
  }
  ...
  function ConnectingState(socket, stage, kb, enterState) {
    this.socket = socket;
    this.stage = stage;
    this.kb = kb;
    this.enterState = enterState;
  }
  ConnectingState.builtin$cls = "ConnectingState";
  if (!"name" in ConnectingState)
    ConnectingState.name = "ConnectingState";
  $desc = $collectedClasses.ConnectingState;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ConnectingState.prototype = $desc;
  ConnectingState.prototype.get$stage = function() {
    return this.stage;
  };
